...
/**
 * Class representing the scoreboard for the game.
 * Keeps track of player points and tokens.
 */
public class ScoreBoard {
    ...
    /**
     * Constructs a ScoreBoard and initializes the points and tokens maps.
     */
    public ScoreBoard() {
        tokens = new HashMap<>();
        points = new HashMap<>();
