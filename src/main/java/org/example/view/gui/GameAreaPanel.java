...
public class GameAreaPanel extends JPanel{
    ...
    public GameAreaPanel(String color, String num) throws IOException {
        ...
        BufferedImage img1 = ImageIO.read(new File("C:\\Users\\jamie\\OneDrive\\Desktop\\102.png"));
        Icon ic1 = new ImageIcon(img1);
        card1 = new JLabel(ic1);

        BufferedImage img2 = ImageIO.read(new File("C:\\Users\\jamie\\OneDrive\\Desktop\\102.png"));
        Icon ic2 = new ImageIcon(img2);
        card2 = new JLabel(ic2);

        BufferedImage img3 = ImageIO.read(new File("C:\\Users\\jamie\\OneDrive\\Desktop\\102.png"));
        Icon ic3 = new ImageIcon(img3);
        card3 = new JLabel(ic3);

        BufferedImage img4 = ImageIO.read(new File("C:\\Users\\jamie\\OneDrive\\Desktop\\102.png"));
