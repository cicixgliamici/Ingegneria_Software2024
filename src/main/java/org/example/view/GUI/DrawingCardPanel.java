...
public class DrawingCardPanel extends JPanel {
    ...
    public DrawingCardPanel() throws IOException {
        ...
        BufferedImage logo2 = ImageIO.read(new File("C:\\\\Users\\\\jamie\\\\OneDrive\\\\Desktop\\\\001.png"));
        Icon icon2 = new ImageIcon(logo2);
        covredCard2 = new JLabel(icon2);

        BufferedImage logo3 = ImageIO.read(new File("C:\\\\Users\\\\jamie\\\\OneDrive\\\\Desktop\\\\001.png"));
        Icon icon3 = new ImageIcon(logo3);
        card1 = new JLabel(icon3);

        BufferedImage logo4 = ImageIO.read(new File("C:\\\\Users\\\\jamie\\\\OneDrive\\\\Desktop\\\\001.png"));
        Icon icon4 = new ImageIcon(logo4);
        card2 = new JLabel(icon4);

        BufferedImage logo5 = ImageIO.read(new File("C:\\\\Users\\\\jamie\\\\OneDrive\\\\Desktop\\\\001.png"));
        Icon icon5 = new ImageIcon(logo5);
        card3 = new JLabel(icon5);

        BufferedImage logo6 = ImageIO.read(new File("C:\\\\Users\\\\jamie\\\\OneDrive\\\\Desktop\\\\001.png"));
