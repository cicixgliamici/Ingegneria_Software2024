...
public class CardSideCornerTest extends TestCase {
    ...
    public void testSetSide(){
        ...
        List<Corner> front = new ArrayList<>(Arrays.asList(c1,c2));
        Corner c3 = new Corner();
        Corner c4 = new Corner();
        List<Corner> back = new ArrayList<>(Arrays.asList(c3,c4));
        SideCard side = new SideCard(Side.FRONT, front, back);
        Card card = new Card(side);
        //setSide(Side)
        card.setSide(side);
        ...
        //setFront()
        Corner newC1 = new Corner();
        Corner newC2 = new Corner();
        List<Corner> newFrontCorners = new ArrayList<>(Arrays.asList(newC1,newC2));
        side.setFront(newFrontCorners);
        assertEquals(newFrontCorners, side.getFrontCorners());
        //setBack()
        Corner newC3 = new Corner();
        Corner newC4 = new Corner();
        List<Corner> newBackCorners = new ArrayList<>(Arrays.asList(newC3,newC4));
        side.setBack(newBackCorners);
        assertEquals(newBackCorners, side.getBackCorners());
    }
